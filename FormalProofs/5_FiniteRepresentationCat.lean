...
/-!
## Lemma stack for theorem 5.19 (`SemiformalProof/5_FiniteRepresentation-cat.md`)

Category-theoretic track (`5_FiniteRepresentation-cat`). Book-aligned sibling: `SemiformalProof/5_FiniteRepresentation-cat.md`.

Assistant-led scaffolding for the Markdown lemma ladder lives in namespace `ai` (see `SemiformalProof/5_FiniteRepresentation-cat-bridge.md`). Chapter lemmas in this file live under `FiniteRepresentationCat` (e.g. `FiniteRepresentationCat.lemma_5_3_i`).
...
**Lemma (adjunction)** from `SemiformalProof/5_FiniteRepresentation-cat.md`: for monotone `f,g`, being a
...
“(left‑adjoint)” in `SemiformalProof/5_FiniteRepresentation-cat.md`.
-/
...
**Lemma (right‑adjoint lemma, packaged on dual orders)** (`SemiformalProof/5_FiniteRepresentation-cat.md`):
...
Proof follows the semiformal case split in `SemiformalProof/5_FiniteRepresentation-cat.md`.
-/
